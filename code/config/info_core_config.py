...
ONE_WAY_CONNECTED_INFO = {"port": "address",
                          "AWS MWS key": "AWS MWS ID",
                          "AWS API Key": "AWS API Gateway",
                          "AWS S3 Bucket": "AWS Access Key ID Value",
                          "Github App Token": "GitHub",
                          "Github OAuth Access Token": "GitHub",
                          "Github Personal Access Token": "GitHub",
                          "Google API Key": "Google (GCP) Service Account",
                          "Google OAuth Access Token": "Google (GCP) Service Account",
                          "SSH (DSA) private key": "SSH",
                          "Slack Token": "Slack",
                          "Slack User token": "Slack",
                          "Slack User token": "Slack",
                          "Slack access token": "Slackwebhook",
                          "Square API Key": "Squareup",
                          "Square OAuth Secret": "Squareup",
                          "Square access token": "Squareup",
                          "Stripe API Key": "Stripe",
                          "Stripe Public Live Key": "Stripe",
                          "Telegram Bot API Key": "Telegram Secret",
                          "Twitter Access Token": "Twitter Secret Key",
                          "Twitter OAuth": "Twitter Client ID",
